...
index_page = html.Div([
    html.H5("Exploratory Data Analysis - Sports"),
    html.H5("GRIP Spark Foundation Internship Task No. 5"),
    html.H5("Mayur Veer"),
    html.H5("m.veer@somaiya.edu"),
    html.H5("https://www.linkedin.com/in/mayur-veer-a66838185/"),
    html.H5("Dataset used: https://bit.ly/34SRn3b"),
    ...
    html.Br(),
    html.H5("Man on the match Table:"),
